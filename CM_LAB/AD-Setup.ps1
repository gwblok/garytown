...
#region Create GPOs
New-GPO -Name "All Servers"
New-GPLink -Name "All Servers" -Target $ServersOU.DistinguishedName

New-GPO -Name "ConfigMgr Servers"
New-GPLink -Name "ConfigMgr Servers" -Target $ServersOU.DistinguishedName
Set-GPPermission -Name "ConfigMgr Servers" -PermissionLevel GpoApply -TargetName "CM Servers" -TargetType Group
Set-GPPermission -Name "ConfigMgr Servers" -PermissionLevel GpoRead -TargetName "Authenticated Users" -TargetType Group -Replace

$RootRootOU = $RootOU.DistinguishedName.Replace("OU=$company,","")
New-GPO -Name "Domain Machines"
New-GPLink -Name "Domain Machines" -Target $RootRootOU
Set-GPPermission -Name "Domain Machines" -PermissionLevel GpoRead -TargetName "Authenticated Users" -TargetType Group -Replace
Set-GPPermission -Name "Domain Machines" -PermissionLevel GpoApply -TargetName "Domain Computers" -TargetType Group
