...
Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/gwblok/garytown/master/CM_LAB/BGInfo/Server.bgi" -OutFile "$ExpandPath\Server_BGInfo.bgi"

#Download Backgound Image
Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/gwblok/garytown/master/CM_LAB/BGInfo/2pint-desktop-product-icons-colour-dark-1920x1080.png" -OutFile "$ExpandPath\2pint-desktop-product-icons-colour-dark-1920x1080.png"
#Create Process Vars
