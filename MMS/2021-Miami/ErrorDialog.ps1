...
$ErrorMessage = $Null
$OrgName = "MMS Miami"
$CustomTitle = "Please remember your survey!"
$ErrorMessage += "You had an error!  Before escalating, please look at the logs and try to figure it out yourself.  Earn your pay check today."
$ErrorCode = 0
$TSStepName = 'TSStepName'
