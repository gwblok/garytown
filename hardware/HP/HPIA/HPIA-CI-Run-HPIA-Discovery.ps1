...
Configuration Manager Config Item - Detect Script
Script will Install HPIA, Run HPIA and determine if system is current or not based on HPIA results.
If NOT current, spits back "Non-Compliant"

USE THIS for the Remediation Script: https://github.com/gwblok/garytown/blob/master/hardware/HP/HPIA/HPIA-PR-Remediation.ps1
