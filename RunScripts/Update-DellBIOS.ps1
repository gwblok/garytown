...
#You'll need to modifiy slightly to support a BIOS Password. - Let me know if that is important for you and I'll see if I get time to update this.
...
if ($Manufacturer -match "Dell")
    ...
    $CabPath = "$env:Windir\Temp\DellCabDownloads\DellSDPCatalogPC.cab"
    $CabPathIndex = "$env:Windir\Temp\DellCabDownloads\CatalogIndexPC.cab"
    $CabPathIndexModel = "$env:Windir\Temp\DellCabDownloads\CatalogIndexModel.cab"
    $DellCabExtractPath = "$env:Windir\Temp\DellCabDownloads\DellCabExtract"
