...
Write-Host -ForegroundColor Green "[+] Import-ModuleLenovoCSM (2.3.0)                    " -NoNewline; Write-Host "Downloads and Installs the Lenovo CSM PS Module" -ForegroundColor Cyan
