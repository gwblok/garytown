...
#Just Build on D Drive:
$SafeGuardJSONURL = "D:\SafeGuard\AppraiserDatabase\SafeGuardHoldDataBase.json"
$SafeGuardDataLocal = Get-Content -Path $SafeGuardJSONURL  | ConvertFrom-Json
$SafeGuardDataLocal.count
