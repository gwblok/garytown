...
$EXE = "cmd.exe"
$ARG = '/c start /MIN c:\windows\System32\WindowsPowershell\v1.0\powershell.exe -ExecutionPolicy ByPass -File C:\ProgramData\WaaS\PreInstall\PreInstallNotification.ps1'
