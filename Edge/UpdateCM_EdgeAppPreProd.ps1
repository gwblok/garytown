...
if (Test-NetConnection proxy-nsp-tmpe.wellsfargo.com -Port 8080) 
    {
    $UseProxy = $true
...
[system.net.webrequest]::DefaultWebProxy = new-object system.net.webproxy('http://proxy-nsp-tmpe.wellsfargo.com:8080')
